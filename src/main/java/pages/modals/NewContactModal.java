...
import elements.*;
import elements.contact.LightningBaseComboboxContact;
...
public class NewContactModal extends BaseModal {
    ...
    public void fillingOutTheForm(Contact inputContact) {
        ...
        new LightningBaseComboboxContact(driver, "Search Accounts...").selectByVisibleText(inputContact.getAccountName());
